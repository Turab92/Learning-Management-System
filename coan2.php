      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            $total=0;
            $con=0;
            $fetch_emp = mysqli_query($conn,"SELECT act.ACC_DESCRIPTION, ch.HEAD_CODE, ch.HEAD_DESC, atd.DESCRIPTION FROM `chart_head` as ch JOIN account_types as act on ch.ACC_TYPE=act.ACCOUNT_TYPE JOIN account_types_detail as atd on ch.ACC_DETAIL_TYPE=atd.ACC_DETAIL_TYPE order by  ch.HEAD_CODE desc");
            foreach($fetch_emp as $emp)
            {
                $HEAD_CODE=$emp['HEAD_CODE'];
                ...
                ?>
					...
					<td><span class='action'><a href='edit_coan2.php?edit=<?php echo $HEAD_CODE; ?>'>Edit</a></span></td>
                    <td><span class='action'><a href='delete.php?HEAD_CODE=<?php echo $HEAD_CODE; ?>' class='delete show' title='Delete'>X</a></span></td>
           </tr>
                <?php $s_no++; }?>
