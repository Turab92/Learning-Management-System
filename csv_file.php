    ...
    if($_FILES['file']["size"] > 0)
    {
      ...
      while (($emapData = fgetcsv($file, 30000, ",")) !== FALSE)
      {
          ...
          $count++;                                      // add this line
			...
			$middle = strtotime($emapData[13]);             // returns bool(false)
			$mysqldate1 = date('Y-m-d', $middle);
		  
			//$old_date1 = date($emapData[14]);            // works
			$middle1 = strtotime($emapData[14]);             // returns bool(false)
			$mysqldate = date('Y-m-d', $middle1);
			
          if($count>1){                                  // add this line
		          //INSERT INTO `student_current_status`(`APPLICANT_NAME`, `FATHER_NAME`, `DATE_OF_BIRTH`, `APPLICANT_ADDRESS`, `GUARDIAN_NAME`, `GUARDIAN_CNIC_NO`, `APPLICANT_NATIONALITY`, `GENDER`, `RELIGION`, `GUARDIAN_NATIONALITY`, `GUARDIAN_PROFFESSION`, `DATE_OF_SUBMISSION`, `CONTACT_PERSON_MOB`,  `CLASS_ID`,  `APPLICANT_CONTACT_RES_NO`, `SESSION_ID`, `EMAIL`,  `SECTION_ID`, `RF_ID`, `BRANCH_ID`, `APPLICANT_EMAIL`)
            $sql = "INSERT INTO `student_current_status`(`APPLICANT_NAME`, `FATHER_NAME`, `DATE_OF_BIRTH`, `APPLICANT_ADDRESS`, `GUARDIAN_NAME`, `GUARDIAN_CNIC_NO`, `APPLICANT_NATIONALITY`, `GENDER`, `RELIGION`, `GUARDIAN_NATIONALITY`, `GUARDIAN_PROFFESSION`, `DATE_OF_SUBMISSION`, `CONTACT_PERSON_MOB`,  `CLASS_ID`, `APPLICANT_CONTACT_RES_NO`,  `SESSION_ID`,`EMAIL`, `BRANCH_ID`,  `SECTION_ID`, `RF_ID`, `APPLICANT_EMAIL`, `ADMISSION_FORM_ID`) VALUES 
			('$emapData[4]','$emapData[16]','$emapData[8]','$emapData[21]','$emapData[16]','$emapData[17]','$emapData[10]','$emapData[7]','$emapData[11]','$emapData[10]','$emapData[23]','$emapData[9]','$emapData[18]','$emapData[1]','$emapData[19]','$emapData[27]','$emapData[5]','$emapData[26]','$emapData[2]','$emapData[3]','$emapData[5]','$emapData[28]')";
            mysqli_query($conn,$sql);
          }                                              // add this lineINSERT INTO `student_current_status`(`APPLICANT_NAME`, `FATHER_NAME`, `DATE_OF_BIRTH`, `APPLICANT_ADDRESS`, `GUARDIAN_NAME`, `GUARDIAN_CNIC_NO`, `APPLICANT_NATIONALITY`, `GENDER`, `RELIGION`, `GUARDIAN_NATIONALITY`, `GUARDIAN_PROFFESSION`, `DATE_OF_SUBMISSION`, `CONTACT_PERSON_MOB`,  `CLASS_ID`,  `APPLICANT_CONTACT_RES_NO`, `SESSION_ID`, `EMAIL`,  `SECTION_ID`, `RF_ID`, `BRANCH_ID`, `APPLICANT_EMAIL`) values ('$emapData[6]','$emapData[22]','$mysqldate1','$emapData[27]','$emapData[22]','$emapData[23]','$emapData[15]','$emapData[12]','$emapData[17]','$emapData[15]','$emapData[29]','$mysqldate','$emapData[25]','$emapData[2]','$emapData[24]','$emapData[9]','$emapData[7]','$emapData[4]','$emapData[5]','$emapData[10]','$emapData[7]')
		 
      }										//INSERT INTO `admission_test`( `APPLICANT_NAME`, `FATHER_NAME`, `DATE_OF_BIRTH`, `APPLICANT_ADDRESS`, `GUARDIAN_NAME`, `GUARDIAN_CNIC_NO`, `APPLICANT_NATIONALITY`, `GENDER`, `RELIGION`, `GUARDIAN_NATIONALITY`, `GUARDIAN_PROFFESSION`, `DATE_OF_SUBMISSION`,  `CONTACT_PERSON_MOB`, `CLASS_ID`, `APPLICANT_CONTACT_NO`,   `SESSION_ID`,`APPLICANT_EMAIL`, `BRANCH_ID`, `IS_PROFILE_MADE`) VALUES 
			                               //('$emapData[4]','$emapData[16]','$emapData[8]','$emapData[21]','$emapData[16]','$emapData[17]','$emapData[10]','$emapData[7]','$emapData[11]','$emapData[10]','$emapData[23]','$emapData[9]','$emapData[18]','$emapData[1]','$emapData[19]','$emapData[27]','$emapData[5]','$emapData[26]','1')";
