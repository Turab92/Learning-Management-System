      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            $total=0;
            $con=0;
            $fetch_emp = mysqli_query($conn,"SELECT `doc_id`, `doc_name` FROM `documents` order by doc_id desc");
            foreach($fetch_emp as $emp)
            {
                ...
                ?>
					...
					<td><span class='action'><a href='edit_document.php?edit=<?php echo $doc_id; ?>'>Edit</a></span></td>
                    <td><span class='action'><a href='delete.php?doc_id=<?php echo $doc_id; ?>' class='delete show' title='Delete'>X</a></span></td>
           </tr>
                <?php $s_no++; }?>
