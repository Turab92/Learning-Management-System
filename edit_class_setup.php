    ...
    <section class="content">
      <div class="row">
        <?php
				if(isset($_GET['edit'])) {
					 $CLASS_ID = $_GET['edit'];
					 $fetch_emp = mysqli_query($conn,"SELECT * from class_setup where CLASS_ID='$CLASS_ID'");
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  method="POST" action="">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="classname" name="classname" value="<?php echo $erow['CLASS_DESCRIPTION']; ?>">
                  </div>
                </div>
			...
			<?php
						if (isset($_POST['btnsub'])) {
								...
								$query="UPDATE `class_setup` SET `CLASS_DESCRIPTION`='".$classname."'   WHERE `CLASS_ID` = '$CLASS_ID'";
