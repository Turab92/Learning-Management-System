      ...
      <div class="row">
        <?php
				if(isset($_GET['edit']) ) {
					 ...
					 $fetch_emp = mysqli_query($conn,"select b.ACC_TYPE,b.ACC_DETAIL_TYPE,b.chart_head_code,b.CHART_ACC_CODE, b.COMPANY_ID,b.tr_no,h.ACC_DESCRIPTION as accoundesc,c.HEAD_DESC,t.DESCRIPTION,p.CHART_ACC_DESC,ci.COMP_NAME 
  from chart_detail_company b, account_types h, chart_head c, account_types_detail t,chart_detail p,comp_info ci
  where b.tr_no='$TR_NO'
  and 
		...
		and b.COMPANY_ID=ci.COMPANY_ID");
          ...
          <div class="box box-info">
			...
			<?php
						if (isset($_POST['btnsub'])) {
								...
								$r1 = mysqli_query($conn, "select * from chart_detail_company where acc_type = '$type' and acc_detail_type = '$type1' and chart_head_code = '$type2' and chart_acc_code = '$type3' and company_id = '$company'");  
							...
							if($run==0){
								...
								$query="UPDATE `chart_detail_company` SET `COMPANY_ID`='".$company."'   WHERE  TR_NO='$TR_NO' ";
								$result = $conn->query($query);
								 echo"<script type='text/javascript'>alert('Record Successfully Updated');</script>";
								echo "<script>location.href='coan4'; </script>";
							}
							else
							{
