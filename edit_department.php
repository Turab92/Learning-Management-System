      ...
      <div class="row">
       <?php
				if(isset($_GET['edit'])) {
					 ...
					 $fetch_emp = mysqli_query($conn,"SELECT * FROM `department` where DEPARTMENT_ID='$DEPARTMENT_ID'");
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="POST" action="">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="department" name="department" value="<?php echo $erow['DESCRIPTION']; ?>">
                  </div>
                </div>
			...
			<?php
						if (isset($_POST['btnsub'])) {
								...
								$query="UPDATE `department` SET `DESCRIPTION`='".$department."'  WHERE `DEPARTMENT_ID` = '$DEPARTMENT_ID'";
