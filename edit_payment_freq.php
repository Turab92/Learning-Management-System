    ...
    <section class="content">
      <div class="row">
       <?php
				if(isset($_GET['edit'])) {
					 $UNIT_ID = $_GET['edit'];
					 $fetch_emp = mysqli_query($conn,"SELECT * FROM `payment_frequency_unit` WHERE UNIT_ID='$UNIT_ID'");
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  method="POST" action="">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="number" class="form-control" id="numdate" name="numdate" value="<?php echo $erow['NO_DAYS']; ?>">
                  </div>
                </div>
			...
			<?php
						if (isset($_POST['btnsub'])) {
								...
								$query="UPDATE `payment_frequency_unit` SET `DESCRIPTION`='".$descrip."',`NO_DAYS`='".$numdate."'   WHERE `UNIT_ID` = '$UNIT_ID'";
								$result = $conn->query($query);
								 echo"<script type='text/javascript'>alert('Record Successfully Updated');</script>";
								echo "<script>location.href='payment_frequency.php'; </script>";
						}
						?>
          </div>
