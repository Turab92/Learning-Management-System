...
<?php
				if(isset($_GET['edit'])) {
					 $sub_id = $_GET['edit'];
					 $fetch_emp = mysqli_query($conn,"SELECT * FROM `subjects` where sub_id='$sub_id'");
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Subject Setup</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="subject" name="subject" value="<?php echo $erow['sub_name']; ?>">
                  </div>
                </div>
			...
			<?php
						if (isset($_POST['btnsub'])) {
								...
								$query="UPDATE `subjects` SET `sub_name`='".$subject."'   WHERE `sub_id` = '$sub_id'";
