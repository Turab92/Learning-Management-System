          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  method="POST" action="">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="nature" name="nature" placeholder="Enter some Text">
                  </div>
                </div>
				 <div class="form-group">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            $total=0;
            $con=0;
            $fetch_emp = mysqli_query($conn,"SELECT `NATURE_ID`, `DESCRIPTION`,`AMOUNT` FROM `nature_payments` where ACTIVE='Y' order by NATURE_ID desc");
