            ...
            <form class="form-horizontal" method="post" action="">
              <div class="box-body">
			   ...
			   <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="date" name="date" readonly value="<?php echo $time; ?>">
                  </div>
                </div>
              <script>
...
xmlhttp.open("GET","ajax_attendance.php?q="+document.getElementById("id").value+"&&in="+document.getElementById("in").checked+"&&out="+
...
//document.getElementsByName('txt')[0].value= xmlhttp.responseText;
               ...
               <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Student RF ID</label>
