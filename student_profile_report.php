...
//auth
$pagename="Student Profile Report";
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Student Profile Report</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" target="_blank" method="post" action="student_profile_report_pdf" >
              <div class="box-body">
