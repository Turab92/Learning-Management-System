...
//auth
$pagename="Student Strength Class Wise Summary";
...
function showClass(str) {
  ...
  xmlhttp.open("GET","student_strength_ajax.php?q="+str,true);
  xmlhttp.send();
}
</script>
<script>
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Student Strength Class Wise</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" target="_blank" method="post" action="student_strength_pdf" enctype="multipart/form-data" >
              <div class="box-body">
