      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            $total=0;
            $con=0;
            $fetch_emp = mysqli_query($conn,"SELECT * FROM student_current_status where left_date is null order by student_id DESC");
            foreach($fetch_emp as $emp)
            {
                $STUDENT_ID=$emp['STUDENT_ID'];
                $APPLICANT_NAME=$emp['APPLICANT_NAME'];
				 $FATHER_NAME=$emp['FATHER_NAME'];
                $DATE_OF_SUBMISSION=$emp['DATE_OF_SUBMISSION'];
				 $IMG=$emp['IMG'];
                ...
                ?>
                    ...
                    <td><?php echo $s_no; ?></td>
					 ...
					 <td><span class='action'><a href='student_profile.php?edit=<?php echo $STUDENT_ID; ?>'><?php echo $APPLICANT_NAME; ?></a></span></td>
